#
#  Be sure to run `pod spec lint ALNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  1. Base Networking Request Function
  ...
  s.homepage     = "https://github.com/Arc-lin/ALNetworking"
